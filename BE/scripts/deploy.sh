...
# 기존 이미지 삭제
sudo docker rmi zinophilsquad/issue-tracker:1.0

# 도커허브 이미지 pull
sudo docker pull zinophilsquad/issue-tracker:1.0

# 도커 run
sudo docker run -d -p 80:8080 --name issue-tracker zinophilsquad/issue-tracker:1.0
